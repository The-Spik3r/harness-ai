...
| STORY-013 | Verdict multi-select, free-text filter and sort controls on the register | feature | ✅ done | medium | [plan](../../plans/PRD-006-admin-console/completed/STORY-013-filter-and-sort-controls.plan.md) | `PENDING` |
