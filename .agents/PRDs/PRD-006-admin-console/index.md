...
| STORY-017 | Manual refresh with a last-refreshed stamp, and a fault panel with retry on both pages | feature | ✅ done | medium | [plan](../../plans/PRD-006-admin-console/completed/STORY-017-refresh-and-fault-panel.plan.md) | `PENDING` |
