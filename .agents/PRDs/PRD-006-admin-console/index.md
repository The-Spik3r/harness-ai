...
| STORY-016 | Copy test pinning the completion label so it cannot regress to "success rate" | technical | ✅ done | small | [plan](../../plans/PRD-006-admin-console/completed/STORY-016-completion-label-copy-test.plan.md) | `PENDING` |
