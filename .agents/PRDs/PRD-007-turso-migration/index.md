...
|----|-------|------|--------|------------|------|--------|
| STORY-001 | Spike: verify the six risky libSQL client behaviors and record the driver decision | spike | ✅ done | medium | [plan](../../plans/PRD-007-turso-migration/completed/STORY-001-libsql-driver-spike.plan.md) | `PENDING` |
| STORY-002 | Characterization tests pinning the three driver-exception behaviors against current SQLite | technical | ⬜ todo | small | — | — |
...
STORY-001, STORY-002, and STORY-003 have no blockers and can start in parallel.
