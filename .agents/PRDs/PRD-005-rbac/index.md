...
| STORY-017 | RBAC test suite — full matrix coverage and ingress parity | technical | ✅ done | medium | [plan](../../plans/PRD-005-rbac/completed/STORY-017-rbac-test-suite.plan.md) | `PENDING` |
