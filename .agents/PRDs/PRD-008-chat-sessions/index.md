...
| STORY-005 | append_chat_message and list_chat_messages, ordered by id and scoped by owner | feature | ✅ done | medium | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-005-message-store-functions.plan.md) | `PENDING` |
