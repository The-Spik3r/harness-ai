...
| STORY-022 | README and .env: document the persistence model the code actually has, including what is now at rest | technical | ✅ done | small | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-022-readme-and-env-docs.plan.md) | `PENDING` |
