...
| STORY-018 | session_rail.py: the spine as the active mark, three states, no fill and no pill | feature | ✅ done | large | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-018-session-rail-component.plan.md) | `117b2b3` |
