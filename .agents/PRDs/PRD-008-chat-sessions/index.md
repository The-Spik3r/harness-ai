...
| STORY-021 | Two instances serve one session, and CHAT_HISTORY_ENABLED=false writes nothing — proven, not assumed | technical | ✅ done | medium | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-021-two-instance-and-flag-off-smoke.plan.md) | `PENDING` |
