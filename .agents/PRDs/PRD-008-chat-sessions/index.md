...
| STORY-012 | ChatSessionSummary plus auto-title derivation and relative activity time in formatting.py | feature | ✅ done | small | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-012-session-summary-and-formatting.plan.md) | `pending` |
