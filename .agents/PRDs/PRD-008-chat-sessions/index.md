...
| STORY-004 | Six user-scoped chat_sessions functions in database.py, with delete as one transaction | feature | ✅ done | medium | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-004-session-crud-functions.plan.md) | `PENDING` |
