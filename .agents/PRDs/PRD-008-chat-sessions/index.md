...
| STORY-020 | Palette-drift and contrast assertions so the sidebar default fails a test, not a review | technical | ✅ done | small | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-020-rail-design-guards.plan.md) | `PENDING` |
