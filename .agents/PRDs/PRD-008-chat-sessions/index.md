...
| STORY-010 | QueryRequest.session_id with UUID validation and a 403 on a foreign session | feature | ✅ done | medium | [plan](../../plans/PRD-008-chat-sessions/completed/STORY-010-query-request-session-id.plan.md) | `PENDING` |
